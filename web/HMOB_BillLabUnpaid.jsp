                    ...
                    <div class="panel panel-inverse">
                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                        ...
                        <div class="panel-body">
                            ...
                            String data = "SELECT * FROM hms_bill_r_billlab p INNER JOIN hms_patient_r_information e ON e.pat_id = p.pat_id where billlabstatus = 'unpaid' ORDER BY billlabid DESC";
                            res = stat.executeQuery(data);
                            while(res.next()){
                            %> 
                            <tr>
                                <td hidden><%=res.getString("billlabid")%></td>
                                <td><%=res.getString("pat_firstname")+" "+res.getString("pat_middlename")+" "+res.getString("pat_lastname")%></td>
                                <td><%=res.getString("billlabdescription")%></td>
                                <td><%=res.getString("billlabfee")%></td>
                                <td><%=res.getString("billlabdateregistered")%></td>
                                <td><span class="label label-warning "><%=res.getString("billlabstatus")%></span></td>
                                
                               <td>
                                          
                                <a href='#?u=<%=res.getString("billlabid")%>' class="btn btn-lime"><i class='fa fa-edit'></i></a>
