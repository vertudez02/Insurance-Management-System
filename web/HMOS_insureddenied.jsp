                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                        ...
                        <div class="panel-body">
                           <a href="HMOS_patientinfo.jsp" class="btn btn-primary" >View Patient Info</a>
                            ...
                            String data = "SELECT * FROM hms_hmo_t_insured p INNER JOIN hms_patient_r_information b ON b.pat_id = p.pat_id INNER JOIN hms_hmo_r_insurance e ON e.insid = p.insid INNER JOIN hms_hmo_r_insurancecategory c ON c.categoryid = p.categoryid INNER JOIN hms_hmo_r_pcp d ON d.pcpid = p.pcpid where insured_status = 'denied' ORDER BY insured_id DESC";
                            ...
                            <tr>
                                ...
                                <td><span class="label label-danger"><%=res.getString("insured_status")%></span></td>
