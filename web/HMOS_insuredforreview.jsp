...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed"><!-- begin #page-container -->	
        ...
        <div id="content" class="content">	<!-- begin of content #content -->
			...
			<!-- begin page-header -->
			<h1 class="page-header">List of Insured</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-12">
                    <div class="panel panel-inverse">
                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                           <h1 class="panel-title" style="color:white;" >Insured Member</h1>
						</div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <a href="HMOS_patientinfo.jsp" class="btn btn-primary" >View Patient info</a>
                             <br>
                             <br>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Insured No</th>
                                        <th class="text-nowrap">Full Name</th>
                                        <th class="text-nowrap">Insurance</th>
                                        <th class="text-nowrap">Category</th>
                                        <th class="text-nowrap">Primary Care Physicians</th>
                            ...
                            String data = "SELECT * FROM hms_hmo_t_insured p INNER JOIN hms_patient_r_information b ON b.pat_id = p.pat_id INNER JOIN hms_hmo_r_insurance e ON e.insid = p.insid INNER JOIN hms_hmo_r_insurancecategory c ON c.categoryid = p.categoryid INNER JOIN hms_hmo_r_pcp d ON d.pcpid = p.pcpid where insured_status = 'for review' ORDER BY insured_id DESC";
                            res = stat.executeQuery(data);
                            while(res.next()){
                            %> 
                            <tr>
                                <td hidden><%=res.getString("insured_id")%></td>
                                ...
                                <td><%=res.getString("pcpname")%></td>
                                <td><%=res.getString("pat_remarks")%></td>
                                <td><%=res.getString("pat_status")%></td>
                                <td><span class="label label-warning"><%=res.getString("insured_status")%></span></td>
                                
                               <td>
                                          
                                <a href='HMOS_applicationUpdate.jsp?u=<%=res.getString("insured_id")%>' class="btn btn-lime"><i class='fa fa-edit'></i></a>
