                    ...
                    <div class="panel panel-inverse">  <!-- begin panel-heading -->
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                        ...
                        <div class="panel-body">  <!-- begin panel-body -->
                            ...
                            <form data-parsley-validate="true" id="AddForm" method="POST" action="HMOV_inscategoryins.jsp">
                                ...
                                <div class="row row-space-10">
                                    <div class="col-md-4">
                                         <div class="form-group m-b-10 p-t-5">
                                            ...
                                            <input id="categoryname" name="categoryname" class="form-control form-control-lg" type="text" placeholder=""  data-parsley-required="true" autofocus="autofocus"/>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group m-b-10 p-t-5">
                                         <label for="username">Description:</label>
                                         <input  id="categorydescription" name="categorydescription" class="form-control form-control-lg"  type="text" placeholder="" data-parsley-required="true" />
                                        </div>
                                    </div>
                                </div>
		...
		App.init(); 
               ...
               TableManageCombine.init();
                ...
                $("#AddBtn").click(function(){
                    ...
                    if($("#insid").val()!= "" && $("#categoryname").val()!= "" && $("#categorydescription").val()!= "")
