...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed"><!-- begin #page-container -->	
        ...
        <div id="content" class="content">	<!-- begin of content #content -->
			...
			<!-- begin page-header -->
			<h1 class="page-header">List of Vendor Registered</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-12">
                    <div class="panel panel-inverse">
                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                           <h1 class="panel-title" style="color:white;" >Registered Vendor</h1>
						</div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <a href="HMOV_vendoraddreg.jsp" class="btn btn-primary" > <i class="fa fa-plus"> New Vendor</i></a>
                             <br>
                             <br>
                            ...
                            String data = "SELECT * FROM hms_hmo_r_insurance where insstatus = 'active' ORDER BY insid DESC";
                            res = stat.executeQuery(data);
                            while(res.next()){
                            %> 
                            <tr>
                                <td hidden><%=res.getString("insid")%></td>
                                <td><%=res.getString("insname")%></td>
                                <td><%=res.getString("insdescription")%></td>
                                <td><span class="label label-primary"><%=res.getString("insremarks")%></span></td>
                                
                               <td>
                                          
                                <a href='#?u=<%=res.getString("insid")%>' class="btn btn-lime"><i class='fa fa-edit'></i></a>
