...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed"><!-- begin #page-container -->	
        ...
        <div id="content" class="content">	<!-- begin of content #content -->
			...
			<!-- begin page-header -->
			<h1 class="page-header">List of Primary Care Physicians</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-12">
                    <div class="panel panel-inverse">
                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                           <h1 class="panel-title" style="color:white;" >Primary Care Physician Registered</h1>
						</div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <br>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Primary Care Physician</th>
                            ...
                            String data = "SELECT * FROM hms_hmo_r_pcp p INNER JOIN hms_hmo_r_insurance b ON b.insid = p.insid  where pcpstatus = 'Active' ORDER BY pcpid DESC";
                            res = stat.executeQuery(data);
                            while(res.next()){
                            %> 
                            <tr>
                                <td hidden><%=res.getString("pcpid")%></td>
                                <td><%=res.getString("pcpname")%></td>
                                <td><%=res.getString("insname")%></td>
                                <td><%=res.getString("pcpemail")%></td>
                                <td><%=res.getString("pcpcontact")%></td>
                                <td><span class="label label-primary"><%=res.getString("pcpstatus")%></span></td>
                                
                               <td>
                                          
                                <a href='#?u=<%=res.getString("pcpid")%>' class="btn btn-lime"><i class='fa fa-edit'></i></a>
