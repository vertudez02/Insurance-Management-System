                    ...
                    <div class="panel panel-inverse">
                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                        ...
                        <div class="panel-body">
                            ...
                            String data = "SELECT * FROM hms_bill_r_billdoctor p INNER JOIN hms_hmo_r_pcp d ON d.pcpid = p.pcpid INNER JOIN hms_patient_r_information e ON e.pat_id = p.pat_id where billdocstatus = 'unpaid' ORDER BY billdocid DESC";
                            res = stat.executeQuery(data);
                            while(res.next()){
                            %> 
                            <tr>
                                <td hidden><%=res.getString("billdocid")%></td>
                                ...
                                <td><%=res.getString("billdocdateregistered")%></td>
                                <td><span class="label label-warning "><%=res.getString("billdocstatus")%></span></td>
                                
                               <td>
                                          
                                <a href='#?u=<%=res.getString("billdocid")%>' class="btn btn-lime"><i class='fa fa-edit'></i></a>
