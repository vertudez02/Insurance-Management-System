                    ...
                    <div class="panel panel-inverse">
                       ...
                       <div class="panel-heading" style="background-color: rgb(0,100,157);">
                        ...
                        <div class="panel-body">
                            <br>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Bed No</th>
                            ...
                            String data = "SELECT * FROM hms_bill_r_room p INNER JOIN hms_patient_r_information b ON b.pat_id = p.pat_id where billroomstatus = 'unpaid' ORDER BY billroomid DESC";
                            res = stat.executeQuery(data);
                            while(res.next()){
                            %> 
                            <tr>
                                <td hidden><%=res.getString("billroomid")%></td>
                                <td><%=res.getString("pat_firstname")+" "+res.getString("pat_middlename")+" "+res.getString("pat_lastname")%></td>
                                <td><%=res.getString("billbednum")%></td>
                                <td><%=res.getString("billroomdescriptions")%></td>
                                <td><%=res.getString("billroomfee")%></td>
                                <td><%=res.getString("billroomdateregistered")%></td>
                                <td><span class="label label-warning "><%=res.getString("billroomstatus")%></span></td>
                                
                               <td>
                                          
                                <a href='#?u=<%=res.getString("billroomid")%>' class="btn btn-lime"><i class='fa fa-edit'></i></a>
